...
if(isset($_POST["brand"])){
	...
	echo "
		<div class='nav nav-pills nav-stacked'>
			<li class='active'><a href='#'><h4>Speciality</h4></a></li>
	";
	if(mysqli_num_rows($run_query) > 0){
		while($row = mysqli_fetch_array($run_query)){
			$bid = $row["brand_id"];
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="business" value="multicap@candycup.com">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/MULTICAP/CandyCupSweets/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/MULTICAP/CandyCupSweets/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/MULTICAP/CandyCupSweets/cancel.php"/>
